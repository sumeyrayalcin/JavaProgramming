...
public class StringMethods {
    public static void main(String[] args) {
        String str = "";
        boolean r = str.isEmpty();   // tirnaklarin arasinda alan yoksa bos , boslik varsa bile saiyor

        System.out.println(r);

        boolean r1 = str.isBlank(); // tirnaklarin arasindaki bosluklari saymadan bos diyor
