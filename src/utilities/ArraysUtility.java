...
public class ArraysUtility {
    ...
    //prints each double of an double array in separete Lines
    ...
    //prints each char of an char array in separete Lines
    ...
    //prints each String of an string array in separete Lines
    ...
    //returns the minumum number from integer array
    ...
    // cheks if the given integer is contained in the given array , returns boolean . contains(int[],int)
    ...
    // cheks if the given double is contained in the given array , returns boolean . contains(int[],int)
    ...
    // cheks if the given char is contained in the given array , returns boolean . contains(int[],int)
    ...
    // cheks if the given String is contained in the given array , returns boolean . contains(int[],int)
    ...
    //add the given element to arrray, returns a new array
